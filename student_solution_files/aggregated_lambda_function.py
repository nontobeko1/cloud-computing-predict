...
def lambda_handler(event, context):
    ...
    # dec_dict = {
    #             "name": "Nontobeko",
    #             "email": "Nonto.portfolio@gmail.com",
    #             "phone": "0123456789",
    #             "message": "Good Day Explore Data Science Student,\
    #                         \
    #                         Your website is beautiful and so are the projects you have done. I had a look at your GitHub page and I am quite impressed with the quality of your work.\
    #                         Could you please forward me your CV so that I can present you for a potential job at one of my clients. It is for a twelve month contract and I feel that your experience and skills match the job specifications perfectly.\
...
def lambda_handler(event, context):
    ...
    table = dynamodb.Table('2401FTDE-NONDUB-portfolio-data-table')
    ...
    # --- Insert your code here ---
    key_phrases = comprehend.detect_key_phrases(Text=enquiry, LanguageCode='en')  # <--- Insert code to get the key phrases with AWS comprehend
    # -----------------------------
    ...
    # Do not change the name of this variable
    email_text = email-response(dec_dict['name'], critical_phrase_list, phrase, sentiment)
